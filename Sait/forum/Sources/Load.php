...
function loadTheme($id_theme = 0, $initialize = true)
{
	...
	if (isset($modSettings['jquery_source']) && $modSettings['jquery_source'] == 'cdn')
		loadJavascriptFile('https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js', array('external' => true), 'jquery');
	elseif (isset($modSettings['jquery_source']) && $modSettings['jquery_source'] == 'local')
		loadJavascriptFile('jquery-3.2.1.min.js', array('default_theme' => true, 'seed' => false), 'jquery');
