...
$txt['caching_information'] = '<div class="aligncenter underline"><strong>Importante! Leggi qui prima di abilitare queste funzioni.</strong></div><br /> SMF supporta il caching attraverso l\'uso di acceleratori. Gli acceleratori attualmente supportati sono:<br /> <ul class="normallist"> <li>APC</li> <li>eAccelerator</li> <li>Turck MMCache</li> <li>Memcached</li> <li>Zend Platform/Performance Suite (Non Zend Optimizer)</li> <li>XCache</li> </ul> Il caching funziona al meglio se hai PHP compilato con uno dei suddetti ottimizzatori o hai disponibile memcache. Se non hai alcun ottimizzatore installato, SMF effettuerà un caching attraverso l\'uso di file.<br /><br /> SMF effettua caching a diversi livelli. Maggiore è il livello di caching abilitato, maggiore sarà il tempo impiegato dalla CPU per recuperare informazioni nella cache. Se il caching è disponibile sul tuo server, ti raccomandiamo di provare inizialmente il livello 1. <br /><br /> N.B: se usi memcached, dovrai fornire i dettagli del server nelle impostazioni in basso. Tali informazioni dovranno essere inserite, come mostrato nell\'esempio sottostante, in una lista separata da virgole:<br /> &quot;server1,server2,server3:port,server4&quot;<br /><br /> Se non è specificata alcuna porta, SMF utilizzerà la 11211. SMF tenterà di bilanciare approssimativamente il carico sui server. <br /><br />  %1$s';
...
$txt['loadavg_warning'] = '<span class="error">Nota: le impostazioni riportate di seguito devono essere modificate con molta attenzione. Impostare un valore troppo basso potrebbe rendere <strong>inutilizzabile</strong> il forum! Il carico medio attuale è <strong>%01.2f</strong></span>';
...
$txt['loadavg_disabled_windows'] = '<span class="error">Il bilanciamento del carico non è supportato in Windows.</span>';
$txt['loadavg_disabled_conf'] = '<span class="error">Il bilanciamento del carico è disabilitato dalla configurazione del tuo host.</span>';
