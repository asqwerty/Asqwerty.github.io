...
$txt['profile_warning_notify_template_outline'] = '{MEMBER},' . "\n\n" . 'Hai ricevuto un richiamo per %1$s. Per favore, evita in futuro questo comportamento e attieniti alle regole del forum, altrimenti verranno presi dei provvedimenti.' . "\n\n" . '{REGARDS}';
$txt['profile_warning_notify_template_outline_post'] = '{MEMBER},' . "\n\n" . 'Hai ricevuto un richiamo per %1$s, in merito al tuo post: {MESSAGE}. Per favore, evita in futuro questo comportamento e attieniti alle regole del forum, altrimenti verranno presi dei provvedimenti.' . "\n\n" . '{REGARDS}';
