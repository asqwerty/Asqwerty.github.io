...
$txt['security_settings_desc'] = 'Ta strona umo¿liwia Ci ustawienie opcji szczególnie zwi±zanych z bezpieczeñstwem i moderowaniem twojego forum, z uwzglêdnieniem opcji anty-spam.';
...
$txt['localCookies'] = 'W³±cz lokalne przechowywanie plików cookies<div class="smalltext">(SSI nie dzia³a z t± opcj±.)</div>';
$txt['globalCookies'] = 'U¿ywaj plików cookies niezale¿nych od subdomeny<div class="smalltext">(najpierw wy³±cz lokalne pliki cookies!)</div>';
...
$txt['queryless_urls'] = 'Wy¶wietlaj adresy przyjazne wyszukiwarkom<div class="smalltext"><strong>dzia³a tylko w Apache/Lighttpd!</strong></div>';
...
$txt['configure_verification_means_desc'] = '<span class="smalltext">Poni¿ej mo¿esz ustawiæ funkcje dotycz±ce anty-spamu, które wymuszaj± na u¿ytkownikach potwierdzenie, ¿e s± lud¼mi. Ka¿dy u¿ytkownik bêdzie musia³ przej¶æ przez <em>wszystkie</em> zabezpieczenia, wiêc je¶li ustawisz weryfikacjê obrazka oraz pytanie/odpowied¼ - trzeba bêdzie poprawnie odpowiedzieæ na oba testy.</span>';
...
$txt['setup_verification_questions_desc'] = '<span class="smalltext">Je¶li chcesz by u¿ytkownicy odpowiadali na pytania weryfikacyjne, aby zatrzymaæ boty, powiniene¶ ustawiæ kilka pytañ w tabelce poni¿ej. Wybierz w miarê ³atwe pytania; wielko¶æ znaków nie ma znaczenia. Mo¿esz u¿ywaæ tagów BBC, aby sformatowaæ pytania, w celu usuniêcia pytania zwyczajnie wyczy¶æ zawarto¶æ tego pola.</span>';
...
$txt['setting_warning_moderate'] = 'Poziom Ostrze¿enia - wiadomo¶ci u¿ytkownika s± moderowane<div class="smalltext">Warto¶æ poziomu ostrze¿enia, powy¿ej którego, wszystkie wiadomo¶ci u¿ytkownika s± moderowane - 0 aby wy³±czyæ.</div>';
$txt['setting_warning_mute'] = 'Poziom Ostrze¿enia - U¿ytkownik nie mo¿e pisaæ wiadomo¶ci<div class="smalltext">Warto¶æ poziomu ostrze¿enia, powy¿ej którego, u¿ytkownik nie mo¿e pisaæ wiadomo¶ci - 0 aby wy³±czyæ.</div>';
...
$txt['setting_warning_decrement'] = 'Ilo¶æ punktów ostrze¿eñ redukowana co 24 godziny<div class="smalltext">Dotyczy tylko u¿ytkowników, którzy nie otrzymali ¿adnego ostrze¿enia przez ostatnie 24 godziny - ustaw na 0 aby wy³±czyæ.</div>';
$txt['setting_warning_show'] = 'Poka¿ stan ostrze¿eñ dla wszystkich u¿ytkowników<div class="smalltext">Je¶li jest wy³±czony, tylko moderatorzy widz± stan ostrze¿eñ u¿ytkownika.</div>';
$txt['setting_warning_show_mods'] = 'Tylko moderatorzy';
$txt['setting_warning_show_user'] = 'Moderatorzy i u¿ytkownicy z ostrze¿eniem';
$txt['setting_warning_show_all'] = 'Wszyscy u¿ytkownicy';
...
$txt['signature_settings_warning'] = 'Te ustawienia nie dotycz± istniej±cych juz podpisów. Kliknij <a href="' . $scripturl . '?action=admin;area=featuresettings;sa=sig;apply;%2$s=%1$s">tutaj</a> aby zastosowaæ regu³y do wszystkich istniej±cych podpisów.';
$txt['signature_enable'] = 'W³±cz podpisy';
...
$txt['custom_edit_active_desc'] = 'Je¿eli nie jest zaznaczone to pole nie bêdzie pokazywane.';
...
$txt['custom_edit_privacy_see'] = 'U¿ytkownicy widz± to pole; tylko administratorzy mog± edytowaæ';
$txt['custom_edit_privacy_owner'] = 'U¿ytkownicy nie widz± tego pola; w³a¶ciciele oraz administratorzy mog± je edytowaæ';
$txt['custom_edit_privacy_none'] = 'To pole widoczne jest tylko dla administratorów';
$txt['custom_edit_can_search'] = 'Mo¿na wyszukaæ?';
$txt['custom_edit_can_search_desc'] = 'Mo¿na szukaæ wed³ug tego pola na li¶cie u¿ytkowników.';
$txt['custom_edit_mask'] = 'Maska wprowadzania';
$txt['custom_edit_mask_desc'] = 'Maska wprowadzania mo¿e zostaæ wybrana dla pól tekstowych, aby narzuciæ konkretny rodzaj danych.';
$txt['custom_edit_mask_email'] = 'Prawid³owy Email';
$txt['custom_edit_mask_number'] = 'Numeryczny';
$txt['custom_edit_mask_nohtml'] = 'Brak HTML';
$txt['custom_edit_mask_regex'] = 'Wyra¿enie regularne - regex (Zaawansowane)';
...
$txt['core_settings_item_cd_desc'] = 'W³±czenie tej funkcji otworzy nowe opcje wyboru u¿ytkownikom wy¶wietlaj±cym kalendarz, dodawanie i przegl±danie wydarzeñ, pokazywanie urodzin w kalendarzu oraz wiele wiêcej.';
...
$txt['core_settings_item_ml_desc'] = 'W³±czenie logowania moderacji pomo¿e Ci w ¶ledzeniu wszystkich akcji podejmowanych przez moderatorów na forum.';
...
$txt['core_settings_item_rg_desc'] = 'Ta opcja administracyjna pozwala na generowanie ró¿nego rodzaju raportów (które mog± byæ wydrukowane) w celu przywrócenia w ³atwy sposób Twoich obecnych ustawieñ forum - szczególnie przydatne na du¿ych forach.';
$txt['core_settings_item_sp'] = '¦ledzenie Silników Wyszukiwarek';
$txt['core_settings_item_sp_desc'] = 'W³±czenie tej funkcji pozwoli administratorowi na ¶ledzenie silników wyszukiwarek gdy indeksuj± forum.';
...
$txt['add_language_smf_browse'] = 'Wpisz nazwê poszukiwanego jêzyka lub pozostaw puste aby wyszukaæ wszystkie.';
$txt['add_language_smf_install'] = 'Zainstaluj';
$txt['add_language_smf_found'] = 'Nastêpuj±ce jêzyki zosta³y znalezione. Kliknij w ³±cze Zainstaluj obok wybranego jêzyka, zostaniesz przeniesiony do mened¿era aktualizacji pakietu aby zainstalowaæ.';
...
$txt['languages_download_note'] = 'Ta strona wy¶wietla listê wszystkich plików, które s± zawarte w tym pakiecie jêzykowym oraz parê u¿ytecznych informacji o ka¿dym z nich. Wszystkie zaznaczone pliki zostan± przekopiowane.';
$txt['languages_download_info'] = '<strong>Informacja:</strong>
	<ul class="normallist">
		<li>Pliki, które maj± status &quot;Niezapisywalny&quot; nie mog± zostaæ przekopiowane przez SMF w takim stanie i musisz rêcznie nadaæ w³a¶ciwo¶ci za pomoc± klienta FTP lub wype³niæ pola na dole tej strony.</li>
		<li>Informacja o wersji pliku wy¶wietla ostatni± wersjê SMF dla której by³ on zaktualizowany. Pod¶wietlenie na zielono oznacza, ¿e jest on nowszy ni¿ Twój obecny. Pomarañczowy natomiast oznacza tê sam± wersjê, a czerwony starsz± ni¿ Twoja obecna.</li>
		<li>Je¶li plik ju¿ istnieje na Twoim forum, kolumna &quot;Ju¿ istnieje&quot; bêdzie posiada³a jedn± z dwóch warto¶ci. &quot;Identyczny&quot; oznacza, ¿e plik ju¿ istnieje i jest taki sam, wiêc nie ma potrzeby go podmieniaæ. &quot;Inny&quot; oznacza, ¿e jego zawarto¶æ ró¿ni siê w jakim¶ stopniu i zamiana jest prawdopodobnie dobrym rozwi±zaniem.</li>
	</ul>';
