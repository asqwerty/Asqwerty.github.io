...
$txt['paidsubs_test_desc'] = 'Ta opcja ustawia p³atne subskrypcje w tryb &quot;testowy&quot;, który bêdzie, w miarê mo¿liwo¶ci, u¿ywa³ p³atno¶ci sandbox w systemie PayPal, Authorize.net itp. Nie w³±czaj tego, chyba ¿e wiesz co robisz!';
$txt['paidsubs_test_confirm'] = 'Czy na pewno chcesz w³±czyæ tryb testowy?';
...
$txt['paid_currency_code_desc'] = 'Kod u¿ywany przez sprzedawców';
$txt['paid_currency_symbol'] = 'Symbol u¿ywany przez metodê zap³aty';
$txt['paid_currency_symbol_desc'] = 'U¿yj \'%1.2f\' do okre¶lenia, gdzie wstawiæ liczbê, na przyk³ad $%1.2f, %1.2fz³ itp.';
...
$txt['nochex_email_desc'] = 'Email konta sprzedawcy na Nochex. Pozostaw puste, je¶li nie u¿ywasz Nochex';
...
$txt['paid_mod_email_desc'] = 'Gdzie {NAME} jest nazw± cz³onków; {FORUM} jest nazw± spo³eczno¶ci. Temat wiadomo¶ci email powinien byæ na pierwszej linii. Puste pole dla braku powiadomieñ email.';
...
$txt['paid_mod_flexible_price'] = 'Cena subskrypcji zale¿y od czasu wa¿no¶ci';
$txt['paid_mod_price_breakdown'] = 'Elastyczny podzia³ ceny';
$txt['paid_mod_price_breakdown_desc'] = 'Ustaw tutaj ile ma kosztowaæ subskrypcja w zale¿no¶ci od czasu wa¿no¶ci. Na przyk³ad, powinna kosztowaæ 12PLN na okres jednego miesi±ca, ale tylko 100PLN na ca³y rok. Je¶li nie chcesz ustawiæ ceny za okre¶lony okres czasu pozostaw puste.';
...
$txt['paid_all_freq_blank'] = 'Musisz podaæ koszt co najmniej jedenego z czterech okresów trwania.';
...
$txt['paid_empty_member'] = 'Menad¿er p³atnych subskrypcji nie móg³ odzyskaæ ID u¿ytkownika';
$txt['paid_could_not_find_member'] = 'Menad¿er p³atnych subskrypcji nie móg³ znale¼æ u¿ytkownika z ID: %1$d';
$txt['paid_count_not_find_subscription'] = 'Menad¿er p³atnych subskrypcji nie móg³ znale¼æ subskrypcji dla u¿ytkownika ID: %1$s, ID subskrypcji: %2$s';
$txt['paid_count_not_find_subscription_log'] = 'Menad¿er p³atnych subskrypcji nie móg³ znale¼æ logów subskrypcji dla ID u¿ytkownika: %1$s, ID subskrypcji: %2$s';
$txt['paid_count_not_find_outstanding_payment'] = 'Nie mo¿na znale¼æ zaleg³ych p³atno¶ci dla ID u¿ytkownika: %1$s, ID subskrypcji: %2$s (pominiêto)';
