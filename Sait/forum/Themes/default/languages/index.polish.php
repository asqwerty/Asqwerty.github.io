...
$txt['report_sent'] = 'Twój raport zosta³ wys³any pomy¶lnie.';
...
$txt['allow_user_email'] = 'Zezwól u¿ytkownikom na wysy³anie emaili';

$txt['check_all'] = 'Zaznacz wszystko';

// Use numeric entities in the below string.
$txt['database_error'] = 'B³±d bazy danych';
...
$txt['move_topic_unapproved_js'] = 'Uwaga! Ten w±tek nie zosta³ jeszcze zaakceptowany.\\n\\nNie jest zalecane aby¶ przesuwa³ w±tek, chyba ¿e zamierzasz zaakceptowaæ wiadomo¶ci natychmiast po tym ruchu.';
...
$txt['smtp_error'] = 'Wyst±pi³y b³êdy podczas wysy³ania poczty. B³±d: ';
...
$txt['quick_reply_verification'] = 'Po wys³aniu wiadomo¶ci zostaniesz przekierowany do regularnej strony wiadomo¶ci, aby j± zweryfikowaæ %1$s.';
...
$txt['subscribe_webslice'] = 'Zapisz siê do Webslice';
...
$txt['debug_kb'] = 'KB.';
$txt['debug_show'] = 'poka¿';
$txt['debug_cache_hits'] = 'U¿ycia cache:';
