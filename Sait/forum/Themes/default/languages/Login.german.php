...
$txt['registration_agreement'] = 'Registrierungs-Bedingungen';
$txt['agreement_agree'] = 'Ich akzeptiere die Nutzungsbedingungen.';
$txt['agreement_agree_coppa_above'] = 'Ich akzeptiere die Nutzungsbedingungen und bin mindestens %1$d Jahre alt.';
$txt['agreement_agree_coppa_below'] = 'Ich akzeptiere die Nutzungsbedingungen und bin jünger als %1$d Jahre.';
...
$txt['setting_coppaAge_desc'] = '(0 zum deaktivieren)';
$txt['setting_coppaType'] = 'Aktion nach Registrierung unterhalb der Altersgrenze';
$txt['setting_coppaType_reject'] = 'Registrierung ablehnen';
$txt['setting_coppaType_approval'] = 'Erfordert die Genehmigung von Eltern/Erziehungsberechtigten';
$txt['setting_coppaPost'] = 'Postadresse, an welche die Genehmigung gesendet werden soll';
$txt['setting_coppaPost_desc'] = 'Wird nur benötigt, wenn das Mindestalter aktiviert ist.';
...
$txt['admin_register_done'] = 'Benutzer %1$s wurde erfolgreich registriert!';

$txt['coppa_title'] = 'Altersbeschränktes Forum';
$txt['coppa_after_registration'] = 'Danke für deine Registrierung im ' . $context['forum_name'] . ' Forum.<br /><br />Da du als Benutzer unter die Altergrenze von {MINIMUM_AGE} fällst ist nach dem Gesetz eine Genehmigung von deinen Eltern/Erziehungsberechtigten erforderlich, welche es dir erlaubt das Benutzerkonto zu benutzen. Um das Benutzerkonto aktivieren zu lassen, drucke bitte folgendes Formular aus:';
...
$txt['coppa_form_title'] = 'Erlaubnis zum Registrieren im ' . $context['forum_name_html_safe'] . ' Forum';
$txt['coppa_form_address'] = 'Adresse';
$txt['coppa_form_date'] = 'Datum';
$txt['coppa_form_body'] = 'Ich, {PARENT_NAME},<br /><br />erlaube {CHILD_NAME} (Name des Kindes) ein voll registrierter Benutzer des Forums ' . $context['forum_name_html_safe'] . ' mit dem Benutzernamen {USER_NAME} zu werden.<br /><br />Ich bin damit einverstanden, dass bestimmte persönliche Angaben von {USER_NAME} auch von anderen Benutzern im Forum einsehbar sind.<br /><br />Unterschrift:<br />{PARENT_NAME} (Eltern/Erziehungsberechtigte).';
