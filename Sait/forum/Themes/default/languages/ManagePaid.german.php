...
Für all Ihre Bezahlarten sollte diese gesetzt werden auf:
	...
	â€¢ <strong>' . $boardurl . '/subscriptions.php</strong><br /><br />
...
$txt['paid_mod_price_breakdown_desc'] = 'Hier können Sie festlegen wie viel das Abonnement abhängig von der Dauer des Abonnements kosten soll. Beispiel: Kostet ein Monat 12â‚¬, so können Sie für ein Jahr einen Preis von 100â‚¬ angeben. Möchten Sie für eine bestimmte Dauer keinen Preis definieren, so lassen sie dieses Feld frei.';
