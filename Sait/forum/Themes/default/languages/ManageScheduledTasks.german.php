...
$txt['scheduled_tasks_time_offset'] = '<strong>Achtung:</strong> Alle Zeitangaben sind <em>Serverzeiten</em> und berücksichtigen nicht die eingestellt Zeitverschiebung im SMF.';
...
$txt['scheduled_task_desc_daily_maintenance'] = 'Führt täglich wichtige Wartungsarbeiten am Forum aus - sollte nicht deaktiviert werden.';
...
$txt['scheduled_task_fetchSMfiles'] = 'Simple Machines Dateien laden';
$txt['scheduled_task_desc_fetchSMfiles'] = 'Lädt verschiedene Javascript-Dateien, welche Informationen zu Aktualisierungen und andere Angaben enthalten.';
$txt['scheduled_task_birthdayemails'] = 'Geburtstagsnachricht senden';
$txt['scheduled_task_desc_birthdayemails'] = 'Sendet eine E-Mail mit Geburtstagswünschen an die Mitglieder.';
$txt['scheduled_task_weekly_maintenance'] = 'Wöchentliche Wartung';
$txt['scheduled_task_desc_weekly_maintenance'] = 'Führt wöchentlich wichtige Wartungsfunktionen des Forum aus - sollte nicht deaktiviert werden!';
$txt['scheduled_task_paid_subscriptions'] = 'Bezahlte Abonnements prüfen';
$txt['scheduled_task_desc_paid_subscriptions'] = 'Sendet Erinnerungen an noch zu bezahlende Abonnements und löscht alle abgelaufenen Abonnements.';
...
$txt['scheduled_log_empty_log'] = 'Protokoll löschen';
