...
$txt['php_script'] = 'Файлы пакета успешно извлечены, но для установки дальнейшей работы необходимо выполнить PHP код, который поставляется вместе с пакетом модификации';
...
$txt['package_manager'] = 'Менеджер пакетов модификаций';
$txt['install_mod'] = 'Установка мода';
$txt['uninstall_mod'] = 'Удаление мода';
$txt['sql_file'] = 'Файлы пакета успешно извлечены, но для дальнейшей работы необходимо выполнить SQL-запрос, который внесет изменения в базу данных.';
$txt['sql_queries'] = 'SQL-запросы';
...
$txt['delete_list'] = 'Удалить список пакетов';
$txt['php_safe_mode'] = 'Извините, PHP на вашем сервере установлен в SAFE MODE. Эта функция несовместима с SAFE MODE. Извините.';
$txt['lets_try_anyway'] = 'Все равно попробовать.';

$txt['package_manager_desc'] = 'С помощью менеджера пакетов можно загружать и устанавливать различные пакеты модификаций для форума.';
...
$txt['avatar_package'] = 'Аватары';
$txt['language_package'] = 'Языковой пакет';
$txt['unknown_package'] = 'Неизвестный пакет';
...
$txt['packages_latest'] = 'Последние пакеты с сервера';
$txt['packages_latest_fetch'] = 'Невозможно получить информацию о последних и самых популярных пакетах с www.simplemachines.org...';
...
$txt['execute_database_changes'] = 'Изменение базы данных';

$txt['package_install_actions'] = 'Действия при установке пакета';
$txt['package_will_fail_title'] = 'Ошибка в установке пакета';
$txt['package_will_fail_warning'] = 'По крайней мере, одна ошибка возникла при тестовой установке пакета.
        <strong>Настоятельно</strong> не рекомендуется продолжать дальнейшую установку, если не уверены в своих действиях, или не произвели резервное копирование данных.
        Эта ошибка может возникнуть при несовместимости уже установленного пакета с пакетом, который пытаетесь поставить, из-за ошибки в самом пакете, из-за того, что пакет требует наличие другого пакета, который не установлен на форуме, или пакет разработан для другой версии форума SMF.';
...
$txt['package_install_now'] = 'Установить';
$txt['package_uninstall_now'] = 'Удалить';
$txt['package_other_themes'] = 'Установить в другие темы оформления';
$txt['package_other_themes_uninstall'] = 'Удалить из остальных тем оформления.';
$txt['package_other_themes_desc'] = 'Для использования мода в других темах оформления менеджер пакетов должен сделать дополнительные изменения. Пожалуйста, проставьте галочки напротив нужных изменений.';
// Don't use entities in the below string.
...
$txt['package_uninstall_done'] = 'Пакет был удален.';
$txt['package_uninstall_cannot'] = 'Этот пакет не может быть удален, потому что в нем нет программы удаления!<br /><br />Пожалуйста, обратитесь к автору пакета, для более полной информации.';
...
$txt['package_install_options_ftp_user'] = 'Пользователь';
...
$txt['package_ftp_why'] = 'Некоторые файлы, которые менеджер пакетов должен изменить, не имеют прав на запись. Измените эти права, используя FTP.';
...
$txt['package_ftp_username'] = 'Пользователь';
...
$txt['package_db_uninstall'] = 'Удалить все данные, используемые этой модификацией.';
...
$txt['package_emulate_desc'] = 'Некоторые модификации написаны для ранних версий SMF, но совместимы и с более новыми. Вы можете &quot;эмулировать&quot; нужную версию SMF.';
...
$txt['package_file_perms_warning_desc'] = '
	...
	<li>Для использования данной функциональности папки, такие как <i>attachments</i> должны иметь права на запись.</li>
