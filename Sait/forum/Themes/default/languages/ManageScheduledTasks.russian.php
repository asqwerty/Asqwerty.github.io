...
$txt['scheduled_tasks_time_offset'] = '<strong>Примечание:</strong> все значения времени, указанные ниже, это <em>время сервера</em> и они не зависят от смещения, заданного в профиле.';
...
$txt['scheduled_log_empty_log'] = 'Очистить логи';
