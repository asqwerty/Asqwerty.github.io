...
$txt['no_password'] = 'Pole has³o jest puste';
...
$txt['email_in_use'] = 'Podany adres email (%1$s) jest u¿ywany przez innego zarejestrowanego u¿ytkownika. Je¶li to pomy³ka, przejd¼ do strony z logowaniem i postaraj siê przywróciæ has³o na ten adres email.';
...
$txt['cannot_moderate_board'] = 'Nie masz zezwolenia na moderowanie tego dzia³u.';
...
$txt['invalid_email'] = 'Nieprawid³owy adres email lub zakres adresów.<br />Przyk³ad prawid³owego adresu: zly.uzytkownik@brzydkastrona.com.<br />Przyk³ad prawid³owego zakresu adresów: *@*.brzydkastrona.com';
$txt['invalid_expiration_date'] = 'Nieprawid³owa data wyga¶niêcia';
$txt['invalid_hostname'] = 'Nieprawid³owa nazwa dostawcy lub zakres nazw<br />Przyk³ad prawid³owej nazwy: proxy4.zlyhost.com<br />Przyk³ad prawid³owego zakresu nazw: *.zlyhost.com';
...
$txt['ban_trigger_already_exists'] = 'Ten ban (%1$s) ju¿ istnieje w %2$s. ';
...
$txt['error_search_string_small_words'] = 'Ka¿de s³owo musi sk³adaæ siê przynajmniej z dwóch znaków.';
...
$txt['profile_error_password_short'] = 'Twoje has³o musi mieæ co najmniej ' . (empty($modSettings['password_strength']) ? 4 : 8) . ' znaki(ów).';
...
$txt['mboards_parent_own_child_error'] = 'Nie mo¿esz stworzyæ dzia³u nadrzêdnego dla w³asnej kategorii podrzêdnej!';
$txt['mboards_board_own_child_error'] = 'Nie mo¿esz stworzyæ dzia³u dla w³asnej kategorii podrzêdnej!';
