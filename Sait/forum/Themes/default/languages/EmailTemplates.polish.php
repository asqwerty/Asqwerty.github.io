...
Twoje konto na {FORUMNAME} zosta³o usuniête. Prawdopodobna przyczyna: Nie aktywowa³e¶ swojego konta po rejestracji. Je¶li chcesz korzystaæ z forum, musisz powtórzyæ proces rejestracji.
...
'body' => '¯eby ponownie zatwierdziæ Twój adres email, konto zosta³o zdezaktywowane. Kliknij na poni¿szy link, aby ponownie aktywowaæ swoje konto:
{ACTIVATIONLINK}
...
Zanim bêdziesz móg³ siê zalogowaæ, administrator poprosi Twoich rodziców/opiekunów o zgodê na Twoje uczestnictwo w spo³eczno¶ci forum. Wiêcej informacji uzyskasz pod tym adresem:
...
'body' => 'Dziêkujemy za zarejestrowanie siê na {FORUMNAME}. Twoja nazwa u¿ytkownika to {USERNAME}. Je¶li zapomnia³e¶ swojego has³a mo¿esz je zmieniæ w {FORGOTPASSWORDLINK}.
...
'body' => '{POSTERNAME} napisa³ odpowied¼ w w±tku, który ¶ledzisz.
...
'body' => '{USERNAME} w³a¶nie zarejestrowa³/³a siê na Twoim forum. Kliknij w adres poni¿ej, aby obejrzeæ jego profil.
{PROFILELINK}
...
Zanim ten u¿ytkownik bêdzie móg³ korzystaæ z forum, jego konto musi zostaæ zatwierdzone.
Kliknij w link poni¿ej, aby przej¶æ do ekranu zatwierdzenia konta.
{APPROVALLINK}
...
Kiedy folder za³±czników osi±gnie swój maksymalny rozmiar, u¿ytkownicy nie bêd± mogli dodawaæ za³±czników do postów i ³adowaæ nowych awatarów (je¶li ta opcja jest aktywna).
...
U¿ytkownik wybra³ now± p³atn± subskrypcjê. Poni¿ej znajdziesz szczegó³y:
...
{REGARDS}',
	...
	'karlbenson1' => array(
		...
		'body' => 'Mogli¶my wys³aæ Ci kartkê urodzinow±. Mogli¶my wys³aæ Ci bukiet kwiatów lub tort.
...
Napisali¶my te Serdeczne ¯yczenia Urodzinowe dok³adnie dla Ciebie! 
