...
$helptxt['manage_boards'] = '	<strong>Edytuj dzia³y</strong><br />
	...
	To by³yby kategorie najwy¿szego poziomu. Pod ka¿d± z nich chcia³by¶
	prawdopodobnie stworzyæ hierarchiczne &quot;podkategorie&quot; lub &quot;dzia³y&quot; dla tematów.
	To bêdzie prosta hierarchia ze struktur±: <br />
	<ul class="normallist">
		<li>
			<strong>Sport</strong>
			&nbsp;-  &quot;Kategoria&quot;
		...
		<ul class="normallist">
			...
			<li><strong>Pi³ka no¿na</strong>
			&nbsp;- Kolejne forum w kategorii &quot;Sport&quot;</li>
		</ul>
	</ul>
Kategorie pozwol± Ci na rozdzielenie forum z szerszych tematów (&quot;Motoryzacja, Sporty&quot;), a &quot;Fora&quot; pod nimi s± aktualnymi tematami w których u¿ytkownik mo¿e pisaæ. U¿ytkownik zainteresowany Pinto, napisa³by wiadomo¶æ pod &quot;Motoryzacja->Pinto&quot;. Kategorie pozwol± ludziom szybko znale¼æ konkretnie to, co ich interesuje: zamiast &quot;Sklep&quot; mo¿esz mieæ &quot;Sprzêt&quot; oraz &quot;Ubiór&quot;, sklepy do których mo¿esz wej¶æ. Zdecydowanie upraszcza wyszukiwanie &quot;p³yta g³ówna&quot;, poniewa¿ mo¿esz przej¶æ do &quot;kategorii&quot; sklepu - Sprzêt zamiast szukaæ w sklepie z ubiorem (gdzie raczej ciê¿ko o p³ytê g³ówn±).<br />
Tak jak podano wy¿ej, Forum jest konkretnym tematem w szerszej kategorii. Je¶li chcesz rozmawiaæ o &quot;Pinto&quot;, przejdziesz do kategorii &quot;Auto&quot;, a nastêpnie wybierzesz forum Pinto i napiszesz to co masz namy¶li.<br />
Funkcje zarz±dzania dla tego menu pozwalaj± na tworzenie for dla ka¿dej kategorii oraz zmiana ich kolejno¶ci (np. przesuñ &quot;Pinto&quot; przed &quot;Chevy&quot;) lub ca³kowite usuniêcie forum.';
...
$helptxt['featuresettings'] = '<strong>W³a¶ciwo¶ci i Opcje</strong><br />
	Jest tu kilka ustawieñ, które mo¿esz zmieniæ wed³ug swoich preferencji.';
...
$helptxt['time_format'] = '<strong>Format Czasu</strong><br />
	Mo¿esz dostosowaæ sposób wy¶wietlania daty i czasu do swoich upodobañ. Wygl±da to na do¶æ skomplikowany ci±g literek, ale nie jest specjalnie trudne.
	...
	&nbsp;&nbsp;%d - dzieñ miesi±ca (01 do 31) <br />
	&nbsp;&nbsp;%D<b>*</b> - to samo, co %m/%d/%y <br />
	&nbsp;&nbsp;%e<b>*</b> - dzieñ miesi±ca (1 do 31) <br />
	&nbsp;&nbsp;%H - godzina (format 24-godzinny)<br />
	&nbsp;&nbsp;%I - godzina (format 12-godzinny)<br />
	&nbsp;&nbsp;%m - miesi±c jako liczba (01 do 12) <br />
	...
	&nbsp;&nbsp;%% - Znak \'%\' literowy <br />
	<br />
	<em>* Nie dzia³a na serwerach opartych na systemie Windows.</em></span>';
...
$helptxt['warning_enable'] = '<strong>System Ostrze¿eñ U¿ytkowników</strong><br />
	...
	<ul class="normallist">
		...
		<li>
			...
			Ka¿dy u¿ytkownik, który przekroczy ustawion± warto¶æ, bêdzie musia³ otrzymaæ zgodê moderatora, na publikacjê ka¿dej wiadomo¶ci na forum.
			To ustawienie bêdzie nadrzêdne do wszystkich lokalnych zezwoleñ zwi±zanych z moderacj± wiadomo¶ci.
		</li>
		<li>
			<strong>Poziom Ostrze¿enia - U¿ytkownik nie mo¿e pisaæ wiadomo¶ci</strong><br />
			Przekroczenie ustawionego poziomu, spowoduje ca³kowity brak mo¿liwo¶ci pisania wiadomo¶ci na forum. 
		</li>
		<li>
			...
			To ustawienie pozwala ograniczyæ aktywno¶æ administratorów w krótkim okresie czasu. Pamiêtaj, mo¿na wy³±czyæ tê opcjê, ustawiaj±c warto¶æ na zero. 
...
$helptxt['error_log'] = '<strong>Raport b³êdów forum</strong><br />
	...
	Za pomoc± strza³ek, mo¿na zmieniæ sortowanie, a dodatkowo mo¿na w³±czyæ filtr, np. wed³ug u¿ytkownika. 
...
$helptxt['theme_settings'] = '<strong>Ustawienia stylu</strong><br />
	Ekran ten pozwala na zmianê specyficznych ustawieñ dla obecnego stylu, w³±czaj±c w to opcje takie jak 
...
$helptxt['smileys'] = '<strong>Centrum U¶mieszków</strong><br />
	Tutaj mo¿esz dodawaæ i usuwaæ u¶mieszki i zestawy u¶mieszków. Zauwa¿, ¿e je¶li u¶mieszek znajduje siê w jednym zestawie, to istnieje równie¿ w pozosta³ych zestawach - w przeciwnym wypadku 
...
$helptxt['enableAllMessages'] = 'Definiuje <em>maksymaln±</em> ilo¶æ wiadomo¶ci w w±tku, dla którego zostanie wy¶wietlony link do wszystkich wiadomo¶ci. Ustawienie tej ilo¶ci na mniej ni¿ &quot;Maksymalna ilo¶æ wiadomo¶ci do wy¶wietlenia na stronie w±tku&quot; spowoduje, ¿e link nigdy siê nie pojawi, a zbyt du¿a warto¶æ mo¿e spowolniæ Twoje forum.';
$helptxt['enableStickyTopics'] = 'Przyklejone w±tki s± w±tkami które pozostaj± stale na górze listy tematów. Zazwyczaj u¿ywane s± do przekazania wa¿nych wiadomo¶ci. 
...
$helptxt['allow_guestAccess'] = 'Odznaczenie tej opcji wy³±czy go¶ciom wykonywanie wiêkszo¶ci czynno¶ci poza tymi najprostszymi - logowanie, rejestracja, przypomnienie has³a, itp. - na Twoim forum. Nie jest to to samo co uniemo¿liwienie go¶ciom dostêpu do dzia³ów.';
$helptxt['userLanguage'] = 'W³±czenie tej opcji pozwoli u¿ytkownikom wybraæ plik jêzykowy z którego bêd± korzystaæ. Nie bêdzie to mia³o wp³ywu na 
		ustawienia domy¶lne.';
$helptxt['trackStats'] = 'Statystyki:<br />Ta opcja pozwoli na wy¶wietlanie u¿ytkownikom listy najnowszych wiadomo¶ci oraz najbardziej popularnych w±tków na Twoim forum. 
...
$helptxt['topbottomEnable'] = 'Dodaje przyciski w górê i w dó³, przez co u¿ytkownicy mog± przenie¶æ siê na koniec i pocz±tek strony 
		bez przewijania.';
...
$helptxt['enablePreviousNext'] = 'Ta opcja spowoduje wy¶wietlanie odno¶nika do nastêpnego i poprzedniego w±tku.';
...
$helptxt['disableTemplateEval'] = 'Domy¶lnie, szablony s± oszacowywane zamiast zwyczajnego osadzenia. To pomaga przy wyszukiwaniu i usuwaniu usterek przez pokazywanie informacji w razie, gdyby szablon zawiera³ b³±d.<br /><br />
		Jednak na du¿ych forach, ten zmodyfikowany system osadzania kodu mo¿e znacz±co spowolniæ wczytywanie. Dlatego zaawansowani u¿ytkownicy mogliby chcieæ to wy³±czyæ.';
...
$helptxt['enableErrorLogging'] = 'Ta opcja powoduje logowanie wszystkich b³êdów, jak np. b³êdne logowania, tak aby mo¿na by³o zobaczyæ, co posz³o ¼le.';
...
$helptxt['disallow_sendBody'] = 'Ta opcja usuwa opcjê otrzymywania tre¶ci odpowiedzi i wiadomo¶ci w powiadomieniach wysy³anych na email.<br /><br />Czêsto u¿ytkownicy odpowiadaj± na takie powiadomienia, a to w wiêkszo¶ci przypadków oznacza, ¿e odpowied¼ otrzymuje webmaster.';
...
$helptxt['timeLoadPageEnable'] = 'Ta opcja bêdzie pokazywaæ na dole strony forum czas w sekundach jakie SMF zajê³o wygenerowanie strony.';
$helptxt['removeNestedQuotes'] = 'Ta opcja wy³±czy wklejanie zagnie¿d¿onych cytatów, podczas cytowania wiadomo¶ci.';
$helptxt['simpleSearch'] = 'Ta opcja wy¶wietli prosty formularz wyszukiwania i link do bardziej zaawansowanego formularza.';
$helptxt['max_image_width'] = 'Ta opcja pozwala na ustawienie maksymalnego rozmiaru wysy³anych obrazków. Nie bêdzie to mia³o wp³ywu na obrazki mniejsze ni¿ maksimum.';
$helptxt['mail_type'] = 'To ustawienie pozwala Ci wybraæ pomiêdzy domy¶lnymi ustawieniami PHP a zast±pieniem tych ustawieñ przez SMTP. PHP nie obs³uguje autoryzacji SMTP (której wiele serwerów aktualnie wymaga), tak wiêc je¶li jest ona dla Ciebie konieczna, powiniene¶ wybraæ SMTP. Miej na uwadze, ¿e SMTP mo¿e dzia³aæ wolniej, a niektóre serwery mog± nie przyjmowaæ nazwy u¿ytkownika i has³a.<br /><br />Nie musisz wype³niaæ ustawieñ SMTP je¶li zdecydowa³e¶ siê na domy¶lne ustawienia PHP.';
$helptxt['attachment_manager_settings'] = 'Za³±cznik to plik, który mo¿e zostaæ wys³any na serwer przez u¿ytkownika i mo¿e zostaæ dodany do wiadomo¶ci.<br /><br />
		...
		<strong>Maksymalny rozmiar za³±czników na jedn± wiadomo¶æ</strong> (w KB):<br /> Okre¶l maksymalny rozmiar wszystkich za³±czników w wiadomo¶ci. Je¶li bêdzie on ni¿szy ni¿ rozmiar przypadaj±cy na za³±cznik, ta wielko¶æ bêdzie ograniczeniem.<br />
...
$helptxt['attachment_image_paranoid'] = 'Zaznaczenie tej opcji umo¿liwi bardzo rygorystyczne sprawdzanie za³±czonych obrazków. Ostrze¿enie! Ta szczegó³owa kontrola mo¿e nie przepu¶ciæ nawet prawid³owych obrazków. Zdecydowanie zalecamy u¿ywanie tej opcji wraz z przekodowywaniem obrazków w celu próbkowania przez SMF tych, które nie zdadz± testu bezpieczeñstwa - je¶li to siê powiedzie, zostan± wyczyszczone oraz za³adowane. W przeciwnym wypadku, je¶li przekodowywanie jest wy³±czone, ka¿dy obrazek, który nie przejdzie testu bezpieczeñstwa, zostanie odrzucony.';
$helptxt['attachment_image_reencode'] = 'Zaznaczenie tej opcji umo¿liwi przekodowywanie za³±czonych obrazków. Przekodowywanie oferuje wiêksze bezpieczeñstwo. Uwaga, przekodowywanie powoduje wy¶wietlanie wszystkich animowanych obrazków jako statyczne. <br /> Ta funkcja jest dostêpna tylko wtedy, gdy modu³ GD jest zainstalowany na serwerze.';
$helptxt['avatar_paranoid'] = 'Zaznaczenie tej opcji umo¿liwi bardzo rygorystyczne sprawdzanie awatarów. Ostrze¿enie! Ta szczegó³owa kontrola mo¿e nie przepu¶ciæ nawet prawid³owych awatarów. Zdecydowanie zalecamy u¿ywanie tej opcji wraz z przekodowywaniem obrazków w celu próbkowania przez SMF tych, które nie zdadz± testu bezpieczeñstwa - je¶li to siê powiedzie, zostan± wyczyszczone oraz za³adowane. W przeciwnym wypadku, je¶li przekodowywanie jest wy³±czone, ka¿dy awatar, który nie przejdzie testu bezpieczeñstwa, zostanie odrzucony.';
$helptxt['avatar_reencode'] = 'Zaznaczenie tej opcji umo¿liwi przekodowywanie za³adowanych awatarów. Przekodowywanie oferuje wiêksze bezpieczeñstwo. Uwaga, przekodowywanie powoduje wy¶wietlanie wszystkich animowanych awatarów jako statyczne. <br /> Ta funkcja jest dostêpna tylko wtedy, gdy modu³ GD jest zainstalowany na serwerze.';
...
$helptxt['cal_enabled'] = 'Kalendarz mo¿e byæ u¿ywany do wy¶wietlania dat urodzin albo wa¿nych wydarzeñ w ¿yciu spo³eczno¶ci.<br /><br />
		...
		<strong>Maksymalna liczba dni na przód w indeksie dzia³ów</strong>:<br />Je¶li ustawione jest na 7, zostan± pokazane wydarzenia z nastêpnego tygodnia.<br />
		<strong>Pokazuj ¶wiêta w indeksie dzia³ów</strong>:<br />Pokazuj dzisiejsze ¶wiêta w tablicy kalendarza w indeksie dzia³ów.<br />
		<strong>Pokazuj urodziny w indeksie dzia³ów</strong>:<br />Pokazuj dzisiejsze urodziny w tabeli kalendarza w indeksie dzia³ów.<br />
		...
		<strong>Zezwól na wydarzenia niepowi±zane z wiadomo¶ciami</strong>:<br />Zezwól u¿ytkownikom wysy³aæ wydarzenia bez wymagania, aby by³y powi±zane z wiadomo¶ci± w dziale.<br />
		...
		Pamiêtaj, ¿e u¿ywanie kalendarza (dodawanie wydarzeñ, pokazywanie wydarzeñ, itp.) mo¿e byæ kontrolowane za pomoc± zezwoleñ w panelu zezwoleñ.';
...
$helptxt['secureCookies'] = 'W³±czenie tej opcji spowoduje wymuszenie oznaczenia cookies stworzonych dla u¿ytkowników Twojego forum jako bezpieczne. W³±cz tê opcjê tylko wtedy, gdy u¿ywasz bezpiecznego protoko³u HTTPS, w przeciwnym wypadku uszkodzi to obs³ugê cookies!';
$helptxt['securityDisable'] = 'Opcja <em>wy³±cza</em> dodatkowe sprawdzanie has³a przy wchodzeniu do sekcji administracyjnej. Nie jest to zalecane!';
$helptxt['securityDisable_why'] = 'Jest to Twoje bie¿±ce has³o. (to samo którego u¿ywasz do logowania.)<br /><br />Wymuszaj±c ponowne wpisanie has³a, system sprawdza czy na pewno <strong>Ty</strong> chcesz wykonaæ jakiekolwiek czynno¶ci administracyjne.';
...
$helptxt['attachmentEncryptFilenames'] = 'Kodowanie nazwy za³±cznika umo¿liwia posiadanie wiêcej ni¿ jednego za³±cznika o tej samej nazwie, 
...
$helptxt['failed_login_threshold'] = 'Ustawia liczbê nieudanych prób logowania zanim u¿ytkownik zostanie przekierowany do strony z przypomnieniem has³a.';
...
$helptxt['edit_disable_time'] = 'Liczba minut po up³ywie których u¿ytkownik nie bêdzie móg³ edytowaæ napisanej przez siebie wiadomo¶ci. Ustaw 0 by wy³±czyæ.<br /><br /><em>Pamiêtaj: Opcja ta nie wp³ynie na u¿ytkowników maj±cych pozwolenie na edycjê wiadomo¶ci pozosta³ych u¿ytkowników.</em>';
$helptxt['posts_require_captcha'] = 'To ustawienie zmusza u¿ytkowników do przej¶cia weryfikacji anty-spam bot, za ka¿dym razem, kiedy chc± napisaæ wiadomo¶æ na forum. Tylko u¿ytkownicy o ilo¶ci napisanych wiadomo¶ci, mniejszej ni¿ ustawiona liczba, bêd± zmuszeni przej¶æ tê procedurê. To powinno pomóc zwalczaæ spamowanie przez automatyczne skrypty.';
...
$helptxt['autoFixDatabase'] = 'Automatycznie naprawia uszkodzone tabele i przywraca dzia³anie forum tak, jakby nic siê nie sta³o. Mo¿e byæ to u¿yteczne, poniewa¿ jedynym sposobem na naprawê jest naprawa tabeli, a dziêki temu forum nie bêdzie wy³±czone dopóki nie dowiesz siê o awarii. Zostaniesz powiadomiony emailem je¶li co¶ takiego siê stanie.';

$helptxt['enableParticipation'] = 'Ta opcja pokazuje ma³± ikonê przy w±tkach, w których u¿ytkownik napisa³.';

$helptxt['db_persist'] = 'Ustal sta³e po³±czenie z baz± danych aby zwiêkszyæ wydajno¶æ. Je¶li nie korzystasz z serwera dedykowanego, mo¿e to powodowaæ problemy z Twoim hostem.';
$helptxt['ssi_db_user'] = 'Opcjonalne ustawienie, które zezwoli na u¿ycie innej nazwy u¿ytkownika oraz has³a do bazy danych, je¶li u¿ywasz SSI.php.';
...
$helptxt['default_personal_text'] = 'Ustawia domy¶lny tekst który u¿ytkownicy bêd± mieli ustawiony w polu &quot;prywatny tekst/podpis.&quot;';
...
$helptxt['password_strength'] = 'To ustawienie okre¶la wymagan± si³ê hase³ u¿ytkowników Twojego forum. Im silniejsze jest has³o, tym trudniej je odgadn±æ lub z³amaæ. 
	...
	<ul class="normallist">
		...
		<li><strong>Wysoka:</strong> To samo, co w ¦rednim, poza tym, ¿e has³o musi sk³adaæ siê z du¿ych i ma³ych liter oraz co najmniej jednej cyfry.</li>
	</ul>';
...
$helptxt['coppaAge'] = 'Warto¶æ podana w tym polu okre¶la minimalny wiek u¿ytkownika pozwalaj±cy na natychmiastow± rejestracjê na forum.
	...
	Je¿eli zostanie wpisane 0 wszelkie restrykcje zwi±zane z wiekiem bêd± ignorowane.';
	...
	<ul class="normallist">
		<li>
			...
			<strong>Wymóg zatwierdzenia przez rodzica b±d¼ opiekuna</strong><br />
				...
				Zostanie te¿ przes³any im standardowy formularz do wype³nienia przez rodziców lub opiekunów, oraz dane kontaktowe, na jaki ma on byæ wys³any.
		</li>
	</ul>';
...
$helptxt['allow_hideOnline'] = 'Zaznaczaj±c tê opcje pozwolisz u¿ytkownikom na ukrycie swojego statusu online przed innymi u¿ytkownikami (oprócz administratorów). Je¿eli opcja pozostanie wy³±czona jedynie osoby moderuj±ce forum bêd± mog³y ukryæ swoj± obecno¶æ. Wy³±czenie tej opcji nie zmieni istniej±cego statusu u¿ytkownika - powstrzyma ich przed ukrywaniem statusu w przysz³o¶ci.';
$helptxt['make_email_viewable'] = 'Je¶li ta opcja jest w³±czona, adresy email u¿ytkowników zamiast byæ ukryte dla cz³onków grup i go¶ci bêd± publicznie widoczne  na forum. W³±czenie tego narazi u¿ytkowników na wielkie ryzyko zostania ofiar± spamu jako rezultat mailowych ¿niwiarzy przegl±daj±cych twoje forum. Zauwa¿, ¿e ta opcja nie nadpisuje ustawieñ u¿ytkowników o ukrywaniu swoich adresów email przed u¿ytkownikami. W³±czenie tej opcji <b>nie</b> jest rekomendowane.';
$helptxt['meta_keywords'] = 'Te s³owa-klucze pojawi± siê w kodzie ka¿dej strony, aby naprowadziæ wyszukiwarki internetowe (itp.) na g³ówn± zawarto¶æ Twojej strony. Powinna to byæ lista s³ów, ka¿de s³owo powinno byæ oddzielone przecinkiem oraz bez u¿ycia HTML. Je¶li pozostawisz to pole puste, wtedy ustawiona bêdzie domy¶lna lista. Oto jak ona wygl±da: <br /><div class="smalltext">&quot;PHP, MySQL, bulletin, board, free, open, source, smf, simple, machines, forum&quot;</div>';

$helptxt['latest_support'] = 'Ten panel pokazuje niektóre z najczêstszych problemów i pytañ dotycz±cych konfiguracji Twojego serwera. Nie martw siê, te informacje nie s± nigdzie zapisywane.<br /><br />Je¶li ca³y czas pojawia komunikat &quot;Retrieving support information...&quot;, Twój komputer prawdopodobnie nie mo¿e po³±czyæ siê z <a href="http://www.simplemachines.org/" target="_blank">www.simplemachines.org</a>.';
...
$helptxt['secret_why_blank'] = 'Ze wzglêdów bezpieczeñstwa odpowied¼ na Twoje pytanie (tak jak i na Twoje has³o) jest zakodowana w taki sposób, ¿e tylko SMF mo¿e go potwierdziæ. Nigdy nie powie Ci (ani nikomu innemu) jaka jest Twoja odpowiedz i has³o.';
...
$helptxt['permissions_deny'] = 'Zabronienie jakiej¶ czynno¶ci jest przydatne, je¶li chcesz zmieniæ pozwolenia konkretnemu u¿ytkownikowi. Mo¿esz te¿ stworzyæ grupê u¿ytkowników z odebranymi prawami i dodaæ tam tych u¿ytkowników.<br /><br />Zalecamy ostro¿ne stosowanie. Po zabronieniu u¿ytkownikowi wybranych czynno¶ci na forum, nie bêdzie on mia³ do nich dostêpu, niezale¿nie od grupy, do której przynale¿y.';
...
$helptxt['maintenance_members'] = 'Pozwala <strong>ca³kowicie</strong> i <strong>nieodwracalnie</strong> usun±æ konta u¿ytkowników z Twojego forum. Zaleca siê zrobiæ najpierw kopiê na wypadek, gdyby zosta³o usuniête co¶, czego nie chcia³e¶ skasowaæ.<br /><br />U¿ywaj tej opcji z nale¿yt± ostro¿no¶ci±.';
...
$helptxt['avatar_external'] = 'Kiedy ta funkcja jest w³±czona, u¿ytkownicy mog± podaæ w³asny URL do awatara. Minusem tego jest to, ¿e w niektórych przypadkach, mog± oni u¿yæ awatara zbyt du¿ego, albo z podobizn±, której sobie nie ¿yczysz na swoim forum.';
$helptxt['avatar_download_external'] = 'Je¿eli w³±czysz tê opcjê, bêdzie mo¿liwe pobranie awatarów z zewnêtrznego adresu URL podanego przez u¿ytkownika. Awatar bêdzie traktowany jak wgrany na serwer.';
...
$helptxt['posts_and_topics'] = '	<ul class="normallist">
		<li>
			...
			Tu w³±czysz mo¿liwo¶æ formatowania wiadomo¶ci, oraz mo¿esz wybraæ które z kodów maj± byæ dostêpne dla u¿ytkowników.
		</li><li>
			...
			Tu mo¿esz zmieniaæ ustawienia dotycz±ce w±tków: ilo¶æ na stronê, ilo¶æ potrzebna by oznaczyæ w±tek jako gor±cy, opcje przyklejonych w±tków itp.
		</li>
	</ul>';
$helptxt['spider_group'] = 'Ustawiaj±c uprawnienia wed³ug grupy, spowodujesz, ¿e kiedy go¶æ zostanie rozpoznany jako robot, jego uprawnienia zmieni± siê ze standardowych go¶cia, na uprawnienia grupy, któr± tu ustawisz. Mo¿esz u¿yæ tej opcji do ograniczenia dostêpu silnikom wyszukiwarek. Przyk³adowo: Stwórz grupê o nazwie &quot;Roboty&quot; i ustaw j± tutaj. Mo¿esz teraz zabraæ tej grupie mo¿liwo¶æ ogl±dania profili u¿ytkowników, co jednocze¶nie uniemo¿liwi robotom indeksowanie profili u¿ytkowników Twojego forum. <br />Uwaga: Detekcja robotów nie jest idealna i mo¿e byæ symulowana przez u¿ytkowników, dlatego nie ma gwarancji, ¿e ograniczenia bêd± zastosowane tylko do silników wyszukiwarek, które doda³e¶.';
$helptxt['show_spider_online'] = 'Te ustawienia pozwol± Ci wybraæ, czy roboty powinny byæ wymienione na li¶cie u¿ytkowników online w indeksie dzia³u i stronie &quot;Kto jest online&quot;. Dostêpne opcje to:
	<ul class="normallist">
		<li>
			...
			Indeks dzia³u wy¶wietli liczbê robotów aktualnie odwiedzaj±cych forum.
		</li><li>
...
$helptxt['move_topics_maintenance'] = 'Ta opcja pozwoli Ci na przesuniêcie wszystkich wiadomo¶ci z wybranego forum na inne forum.';
...
$helptxt['field_show_enclosed'] = 'Osadza w HTML lub tekst wprowadzone przez u¿ytkownika dane. Pozwoli Ci na dodanie wiêkszej ilo¶ci protoko³ów (komunikatorów), obrazków itp. Dla przyk³adu:<br /><br />
		&lt;a href="http://strona.pl/{INPUT}"&gt;&lt;img src="{DEFAULT_IMAGES_URL}/icon.gif" alt="{INPUT}" /&gt;&lt;/a&gt;<br /><br />
		Zauwa¿, ¿e mo¿esz u¿yæ kilka zmiennych:<br />
		<ul class="normallist">
			<li>{INPUT} - Wstawia zawarto¶æ wprowadzon± przez u¿ytkownika.</li>
			<li>{SCRIPTURL} - Adres forum.</li>
			<li>{IMAGES_URL} - Adres folderu z obrazkami obecnego stylu.</li>
			<li>{DEFAULT_IMAGES_URL} - Adres folderu z obrazkami domy¶lnego stylu.</li>
		</ul>';

$helptxt['custom_mask'] = 'Maska wprowadzania jest wa¿na dla bezpieczeñstwa Twojego forum. Sprawdzenie mask± wpisanych przez u¿ytkownika danych ubezpieczy forum przed u¿yciem pól w niepowo³any sposób. Oto lista prosty wyra¿eñ regularnych:<br /><br />
	<span class="smalltext">
		&nbsp;&nbsp;"[A-Za-z]+" - Sprawdza wszystkie wielkie i ma³e litery alfabetu.<br />
		&nbsp;&nbsp;"[0-9]+" - Sprawdza wszystkie cyfry.<br />
		&nbsp;&nbsp;"[A-Za-z0-9]{7}" - Sprawdza wszystkie wielkie i ma³e litery alfabetu oraz cyfry, lecz zezwala na tylko siedem znaków.<br />
		&nbsp;&nbsp;"[^0-9]?" - Zabrania jakiejkolwiek cyfry.<br />
		&nbsp;&nbsp;"^([A-Fa-f0-9]{3}|[A-Fa-f0-9]{6})$" - Pozwala tylko na 3 lub 6 kodów szesnastkowych.<br />
	</span><br /><br />
	Dodatkowo mog± zostaæ zdefiniowane specjalne metaznaki ?+*^$ oraz {xx}.
	<span class="smalltext">
		&nbsp;&nbsp;? - Jeden lub ¿aden znak.<br />
		&nbsp;&nbsp;+ - Jeden lub wiêcej znaków.<br />
		&nbsp;&nbsp;* - ¯aden lub wiêcej znaków<br />
		&nbsp;&nbsp;{xx} - Konkretna liczba znaków.<br />
		&nbsp;&nbsp;{xx,} - Konkretna liczba lub wiêcej znaków.<br />
		&nbsp;&nbsp;{,xx} - Konkretna liczba lub mniej znaków.<br />
		&nbsp;&nbsp;{xx,yy} - Liczba znaków pomiêdzy jedn± a drug± liczb±.<br />
		&nbsp;&nbsp;$ - Pocz±tek ci±gu.<br />
		&nbsp;&nbsp;^ - Koniec ci±gu.<br />
		&nbsp;&nbsp;\\ - Anulowanie znaczenia symboli.<br />
	</span><br /><br />
	Wiêcej informacji oraz zaawansowane techniki znajdziesz w internecie.';
