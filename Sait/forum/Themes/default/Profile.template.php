...
echo '
<tr><td colspan="2" style="font-weight: bold;">'.$txt['social_nets_hdr'].'</td>
</tr>

', !empty($context['member']['options']['vkontakte']) ?'<tr> <td><b>'.$txt['vkontakte'].': </b></td> <td><a href="http://www.vkontakte.ru/id'
. $context['member']['options']['vkontakte'] . ' "target="_blank">'.$txt['my_profile_at'].' '.$txt['vkontakte'].'</a></td></tr>': '', '

', !empty($context['member']['options']['odnoklassniki']) ?'<tr> <td><b>'.$txt['odnoklassniki'].': </b></td> <td><a href="http://www.odnoklassniki.ru/user/'
. $context['member']['options']['odnoklassniki'] . ' "target="_blank">'.$txt['my_profile_at'].' '.$txt['odnoklassniki'].'</a></td></tr>': '', '

', !empty($context['member']['options']['moimir']) ?'<tr> <td><b>'.$txt['moimir'].': </b></td> <td><a href="http://my.mail.ru/'
. $context['member']['options']['moimir'] . ' "target="_blank">'.$txt['my_profile_at'].' '.$txt['moimir'].'</a></td></tr>': '', '

', !empty($context['member']['options']['moikrug']) ?'<tr> <td><b>'.$txt['moikrug'].': </b></td> <td><a href="http://'
. $context['member']['options']['moikrug'] . '.moikrug.ru" "target="_blank">'.$txt['my_profile_at'].' '.$txt['moikrug'].'</a></td></tr>': '', '

', !empty($context['member']['options']['linkedin']) ?'<tr> <td><b>'.$txt['linkedin'].': </b></td> <td><a href="http://www.linkedin.com/'
. $context['member']['options']['linkedin'] . ' "target="_blank">'.$txt['my_profile_at'].' '.$txt['linkedin'].'</a></td></tr>': '', '
