...
function template_html_above()
{
	...
	echo '<!DOCTYPE html>
<html prefix="og: http://ogp.me/ns#"', $context['right_to_left'] ? ' dir="rtl"' : '', '>
<head>
	...
	echo '
	<meta name="description" content="', !empty($context['meta_description']) ? $context['meta_description'] : $context['page_title_html_safe'], '"><LINK REL="shortcut icon" HREF="http://www.skeet.h1n.ru/forum/favicon.ico">', !empty($context['meta_keywords']) ? '
...
function template_body_above()
{
	...
	echo '
	<div id="header">
		<div class="frame"><center><iframe id="shelf" src="..//forum/Themes/default/images/Bookshelf.wdgt/Bookshelf.html" style="border:0px;-webkit-overflow-scrolling: touch;overflow: auto; fub;" name="shelf" scrolling="no" frameborder="0" marginheight="0" marginwidth="0" height="248" width="960" seamless></iframe></center>
			<h1 class="forumtitle">
			</h1>';
	echo'
		</div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WXP7TJ"
...
function theme_linktree($force_show = false)
{
	...
	{
		echo '
			<li', ($link_num == count($context['linktree']) - 1) ? ' class="last"' : '', (empty($shown_linktree) ? ' itemscope itemtype="http://data-vocabulary.org/Breadcrumb"' : ''), '>';
